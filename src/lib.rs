...
#[derive(Debug)]
pub struct GraphRelayProcessor {
    verbose: bool,
    processed_count: usize,
}

impl GraphRelayProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting GraphRelay processing");
    
    let mut processor = GraphRelayProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = GraphRelayProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = GraphRelayProcessor::new(false);
